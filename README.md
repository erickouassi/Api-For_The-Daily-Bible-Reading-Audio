...
This repository provides a simple and clean **API version of the daily Catholic prayers**, originally from the USCCB RSS feed (http://feeds.feedburner.com/usccb/zhqs). The data is automatically updated into a lightweight JSON format for easy use in web and mobile projects via this URL: [https://api-for-the-daily-bible-reading-aud.vercel.app/](https://api-for-the-daily-bible-reading-aud.vercel.app/)  
